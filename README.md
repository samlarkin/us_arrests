...
Inspection and analysis of the `USArrests` dataset, which is built into R. The
analysis uses PCA for dimensionality reduction and compares the results of two
methods of clustering (agglomerative hierarchical clustering and KMeans
clustering).

## About the dataset

The help message in R for this dataset is as follows (`help(USArrests)`):
